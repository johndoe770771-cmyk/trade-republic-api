  ...
  return (
    <Card className="p-6">
      ...
      <div className="mb-6 p-4 rounded-lg bg-secondary/30 border border-border">
        <h3 className="text-sm font-medium text-muted-foreground mb-3">USD Pairs</h3>
        {snapshot ? (
      ...
      {/* EUR Prices */}
      <div className="mb-6 p-4 rounded-lg bg-secondary/30 border border-border">
        <h3 className="text-sm font-medium text-muted-foreground mb-3">EUR Pairs (Calculated)</h3>
        {snapshot ? (
          <div className="space-y-1">
            {renderPriceRow(
